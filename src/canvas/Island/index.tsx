...
Command: npx gltfjsx@6.2.15 ./island-2.glb --types 
*/
...
export function Island(props: JSX.IntrinsicElements["group"]) {
  const { nodes, materials } = useGLTF(
    "/models/island/island-2.glb"
  ) as GLTFResult;
 
  const [aoMap1024] = useTexture(["/models/island/AOMap_1024.png"]);
  useLayoutEffect(() => {
    aoMap1024.flipY = false;
  }, []);
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <RigidBody type="fixed" colliders={false}>
        <MeshCollider type="trimesh">
          ...
          <mesh
            ...
            position={[0.055, 0.222, 0.719]}
            rotation={[0, -0.088, 0]}
            scale={[0.063, 0.002, 0.014]}
          />
          {/* Pier */}
          <group
            position={[-0.205, 0.088, 1.029]}
          ...
          <mesh
            ...
            position={[-2.385, -0.241, 4.081]}
            scale={1.694}
          />
          <mesh
            geometry={nodes.Plane003.geometry}
            material={materials["Material.004"]}
            position={[1.629, -0.241, -4.948]}
      ...
      <RigidBody
        ...
        onCollisionEnter={() => {
            console.log("Enter");
            storeState.isCrossedBorders = true;
        }}
        onCollisionExit={() => {
            console.log("Exit");
            storeState.isCrossedBorders = false;
        }}
        name="water"
      >
        {/* Water */}
...
useGLTF.preload("/models/island/island-2.glb");
