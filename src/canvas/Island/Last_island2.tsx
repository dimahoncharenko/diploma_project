...
export function Island(props: JSX.IntrinsicElements["group"]) {
  ...
  return (
    <group {...props} dispose={null}>
      ...
      />
      <hemisphereLight args={["#ffeb91", "#000000", 1]} />
      <RigidBody type="fixed" colliders={false}>
        <MeshCollider type="trimesh">
          ...
          />
          <group
            position={[-0.192, 0.078, 1.953]}
            rotation={[3.07, 1.043, -2.967]}
          ...
          <mesh geometry={nodes.Landscape_4.geometry}>
            <meshStandardMaterial {...materials["Material.005"]} />
          </mesh>
        </MeshCollider>
      </RigidBody>
    </group>
