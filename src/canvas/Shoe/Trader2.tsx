...
Command: npx gltfjsx@6.2.16 ./female_trader.glb --transform --types 
Files: ./female_trader.glb [1.4MB] > D:\Projects\Sketchpad\ThreeJS Draft\minecraft-prototype\public\models\shoe_trader\female_trader-transformed.glb [876.32KB] (38%)
*/
...
export function Trader(props: JSX.IntrinsicElements["group"]) {
  const { nodes, materials } = useGLTF(
    "/models/shoe_trader/female_trader-transformed.glb"
  ) as GLTFResult;
  ...
  const jsonFile = useMemo(
    () => useLoader(THREE.FileLoader, `/audio/lily_${soundType}.json`),
    [soundType]
  );
...
useGLTF.preload("/models/shoe_trader/female_trader-transformed.glb");
